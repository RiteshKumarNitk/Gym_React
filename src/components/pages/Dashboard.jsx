    ...
    <div className="flex min-h-screen">
      ...
      <div className={`${sidebarOpen ? 'w-54' : 'w-0'} bg-black text-white flex flex-col p-4 transition-all duration-300 overflow-hidden`}>
        <div className="flex items-center gap-4 mb-6">
          <img src={Coach3} alt="profile" className="w-16 h-16 rounded-full" />
          <div>
        ...
        <div className="space-y-4">
          <button className="flex ml-6 items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-purple-400 to-pink-500">
